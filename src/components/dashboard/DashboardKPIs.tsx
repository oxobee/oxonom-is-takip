...
export default function DashboardKPIs({
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-8 gap-3">
      {[
        { val: projectsLength, lbl: 'Proyectos', icon: <FolderKanban size={15} />, bg: 'bg-blue-500/10', iconC: 'text-blue-400', sub: `${execProjects} en ejecución`, click: 'projects' },
        ...
        { val: todayMeetingsLength, lbl: 'Reuniones hoy', icon: <CalendarDays size={15} />, bg: 'bg-purple-500/10', iconC: 'text-purple-400', sub: weekTasksLength > 0 ? `${weekTasksLength} tareas esta semana` : '', click: 'calendar' },
        ...
        { val: openPunchItems, lbl: 'Punch List', icon: <ListChecks size={15} />, bg: 'bg-teal-500/10', iconC: 'text-teal-400', sub: `${punchItemsLength} items totales`, click: 'punchList' },
        ...
        { val: rangeTotalTime > 0 ? fmtHours(rangeTotalTime) : '—', lbl: 'Tiempo', icon: <Timer size={15} />, bg: 'bg-indigo-500/10', iconC: 'text-indigo-400', sub: `${rangeTimeEntriesLength} registros`, click: 'timeTracking' },
      ].map((m, i) => (
