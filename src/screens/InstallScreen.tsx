            ...
            {isStandalone ? (
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-[var(--muted-foreground)] mt-0.5">oxonom iş takip se está ejecutando como aplicación instalada. Puedes cerrar esta guía.</div>
                </div>
              </div>
            ) : installPrompt ? (
                ...
                <div className="space-y-3">
                  <div className={`p-3 rounded-lg ${platform === 'android' ? 'bg-[var(--af-accent)]/10 border border-[var(--af-accent)]/20' : 'bg-[var(--af-bg3)]'}`}>
                    ...
                    <ol className="text-[12px] text-[var(--muted-foreground)] space-y-1 pl-4 list-decimal">
                      <li>Abre oxonom iş takip en Chrome</li>
                  ...
                  <div className={`p-3 rounded-lg ${platform === 'ios' ? 'bg-[var(--af-accent)]/10 border border-[var(--af-accent)]/20' : 'bg-[var(--af-bg3)]'}`}>
                    ...
                    <ol className="text-[12px] text-[var(--muted-foreground)] space-y-1 pl-4 list-decimal">
                      <li>Abre oxonom iş takip en <strong>Safari</strong> (no funciona en Chrome)</li>
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5">
                ...
                <div className="space-y-3">
                  <div className={`p-3 rounded-lg ${platform === 'windows' ? 'bg-[var(--af-accent)]/10 border border-[var(--af-accent)]/20' : 'bg-[var(--af-bg3)]'}`}>
                    ...
                    <ol className="text-[12px] text-[var(--muted-foreground)] space-y-1 pl-4 list-decimal">
                      <li>Abre oxonom iş takip en Chrome o Edge</li>
                      <li>Haz clic en el <strong>ícono de instalar</strong> en la barra de direcciones ( junto al candado), o menú ⋮ → <strong>"Instalar oxonom iş takip"</strong></li>
                  ...
                  <div className={`p-3 rounded-lg ${platform === 'mac' ? 'bg-[var(--af-accent)]/10 border border-[var(--af-accent)]/20' : 'bg-[var(--af-bg3)]'}`}>
                    ...
                    <ol className="text-[12px] text-[var(--muted-foreground)] space-y-1 pl-4 list-decimal">
                      <li><strong>Chrome:</strong> Menú ⋮ → <strong>"Instalar oxonom iş takip"</strong> → Crear acceso directo</li>
